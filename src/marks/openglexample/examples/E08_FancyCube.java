...
public class E08_FancyCube extends JFrame implements GLEventListener {
	...
	public void display(GLAutoDrawable arg0) {
		...
		// Changing the model matrix to a different state as 't' changes.
		Matrix3D mMat = new Matrix3D();
		mMat.translate(Math.sin(16 * t) * 3.0, Math.sin(4 * t) * 2.0, Math.sin(7 * t) * 2.5);
